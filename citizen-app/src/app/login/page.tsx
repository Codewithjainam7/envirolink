...
import { Mail, Lock, LogIn, AlertCircle, ArrowRight, Eye, EyeOff, Leaf } from 'lucide-react';
...
export default function LoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Check if user has a profile (via trigger or manual), but for specific routing we might check role
            // ideally triggers handle the profile creation
        ...
        <div className="min-h-screen bg-gradient-to-br from-emerald-100/80 via-gray-100 to-emerald-50 flex flex-col items-center justify-center p-4 relative overflow-hidden">
            ...
            >
                ...
                <motion.div variants={itemVariants} className="text-center mb-8">
                    <div className="w-20 h-20 mx-auto mb-6 relative flex items-center justify-center bg-emerald-100 rounded-2xl">
                    ...
                    <p className="text-gray-500">Sign in to report and track waste</p>
                </motion.div>
